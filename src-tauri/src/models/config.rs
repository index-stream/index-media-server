...
// Configuration data structures - now only contains server-level settings
...
// These will be removed once all API endpoints are updated to use database
...
pub struct MediaIndex {
    pub id: String,
    pub name: String,
    pub r#type: String, // 'videos', 'photos', 'audio' (no more 'local')
    pub icon: String,
...
// Request structure for updating an index
#[derive(Debug, Deserialize)]
